...
class c_saldo_krl extends CI_Controller{
    ...
    function index(){
        $data['title'] = "DATA SALDO KRL";
        $data['saldo_krl'] = $this->m_transaksi->get_data('v_saldo_krl')->result();
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/transaksi/saldo_krl/index',$data);
