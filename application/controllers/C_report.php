...
class c_report extends CI_Controller{
    ...
    function index(){
        ...
        $data['nasabah_transaksi'] = $this->m_master_data->get_data('nasabah_transaksi')->result();
        $data['get_laporan_tarik'] = $this->m_transaksi->get_laporan_tarik($nasabah_id);
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/report/index',$data);
    ...
    function v_tarik(){
        ...
        $data['get_laporan_tarik'] = $this->m_transaksi->get_laporan_tarik($nasabah_id);
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/report/tarik/v_tarik',$data);
        // $this->load->view('SA_Super_Admin/data_registrasi/krl_master/desa/modal_insert',$data);
        // $this->load->view('SA_Super_Admin/data_registrasi/modal_status',$data);
        $this->load->view('__footer');
    ...
    function v_setor(){
        ...
        $nasabah_id = $this->session->userdata('nasabah_id');
        $data['nasabah_transaksi'] = $this->m_master_data->get_data('nasabah_transaksi')->result();
        $data['get_laporan_setor'] = $this->m_transaksi->get_laporan_setor($nasabah_id);
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/report/setor/v_setor',$data);
        // $this->load->view('SA_Super_Admin/data_registrasi/krl_master/desa/modal_insert',$data);
        // $this->load->view('SA_Super_Admin/data_registrasi/modal_status',$data);
        $this->load->view('__footer');
    ...
    public function filter_tarik() {
        $start_date = $this->input->post('start_date');
        $end_date = $this->input->post('end_date');
        $nasabah_id = $this->session->userdata('nasabah_id');
        $data['results'] = $this->m_transaksi->get_data_by_date_tarik($start_date, $end_date, $nasabah_id);
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/report/tarik/v_filter',$data);
        $this->load->view('__footer');
    }
    public function filter_setor() {
        $start_date = $this->input->post('start_date');
        $end_date = $this->input->post('end_date');
        $nasabah_id = $this->session->userdata('nasabah_id');
        $data['results'] = $this->m_transaksi->get_data_by_date_setor($start_date, $end_date, $nasabah_id);
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/report/setor/v_filter',$data);
        $this->load->view('__footer');
    }
