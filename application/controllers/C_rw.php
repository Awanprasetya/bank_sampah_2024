...
class c_rw extends CI_Controller{
    ...
    function index(){
        $data['title'] = "DATA RW";
        $data['get_desa_rw'] = $this->m_master_data->get_desa_rw();
        $data['rw'] = $this->m_master_data->get_data('rw')->result();
        $data['desa'] = $this->m_master_data->get_data('desa')->result();
        $this->load->view('__header');
        $this->load->view('SA_Super_Admin/master_data/krl_master/rw/index',$data);
        $this->load->view('SA_Super_Admin/master_data/krl_master/rw/modal_insert',$data);
        $this->load->view('SA_Super_Admin/master_data/krl_master/rw/modal_edit',$data);
