...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'assets_landing/css/fontawesome.css'?>">
    <link rel="stylesheet" href="<?php echo base_url().'assets_landing/css/templatemo-seo-dream.css'?>">
    <link rel="stylesheet" href="<?php echo base_url().'assets_landing/css/animated.css'?>">
    <link rel="stylesheet" href="<?php echo base_url().'assets_landing/css/owl.css'?>">
<!--
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="main-blue-button"><a href="<?php echo base_url().'Login/v_login'?>">Masuk / Daftar</a></div></li> 
            </ul>        
  ...
  <script src="<?php echo base_url().'assets_landing/js/owl-carousel.js'?>"></script>
  <script src="<?php echo base_url().'assets_landing/js/animation.js'?>"></script>
  <script src="<?php echo base_url().'assets_landing/js/imagesloaded.js'?>"></script>
  <script src="<?php echo base_url().'assets_landing/js/custom.js'?>"></script>
