	        ...
	        <div class="container">
	            ...
	            <div class="row">
                    ...
                    <img src="<?= base_url().'assets/images/umci1.png'?>" alt="" width="260px"> X <img src="<?= base_url().'assets/images/kecc.png'?>" alt="" width="260px">
	                    ...
	                    <div class="block">
	                        <h1 class="wow fadeInDown">Halo Warga!</h1>
	                        <p class="wow fadeInDown" data-wow-delay="0.3s">Segera jadi bagian komunitas Bank Sampah, dan jadikan sampah sebagai passive income mu! </p>
	                        <div class="wow fadeInDown" data-wow-delay="0.3s">
	                        	<a class="btn btn-default btn-home" href="<?= base_url().'Login/v_login'?>" role="button">Masuk / Daftar</a>
	                        </div>
	                    </div>
	                </div>
	                <div class="col-md-6 wow zoomIn">
	                    <div >
	                        <div class="counter text-center">
	                            <img src="<?php echo base_url().'assets/images/icon-hp.png'?>" alt="">
	                            </ul>
	                        </div>
	                    </div>
	                </div>
