...
<div class="modal" id="editstatusModal<?= $r->registrasi_id?>" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-bordered" name="autoSumForm" autocomplete="off" action="<?php echo base_url().'c_user/edit_status/'.$r->registrasi_id ?>" method="post">
