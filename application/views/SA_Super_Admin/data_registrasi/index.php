...
<?php echo $this->session->flashdata('alert_1');?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Akun Registrasi</h1>
          </div>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard/index' ?>"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="#">Data Akun Registrasi</a></li>
          </ol>
        
          <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?=  base_url().'c_user/index' ?>" >Data Akun Registrasi</a>
            </li>
            ...
            <div class="col-lg-10 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Akun Registrasi </h6>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      foreach($get_user as $r ){
                        ...
                        <tr>
                            ...
                            <!-- <td align="center">
                                <a class="btn btn-info btn-sm" href="<?php echo base_url().'c_user/v_detail/'.$r->registrasi_id?>"><i class="fa fa-info" ></i>&nbsp;Detail</a>
