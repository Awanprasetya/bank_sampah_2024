...
<?php foreach($get_nasabah_transaksi as $r): 
  $kode_transaksi = $r->transaksi_id;
  $nasabah_id = $r->nasabah_id;
  $saldo = $r->nominal_masuk; 
...
<div class="modal" id="editstatusModal<?= $kode_transaksi?>" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-bordered" name="autoSumForm" autocomplete="off" action="<?php echo base_url().'c_setor/edit_status/'.$kode_transaksi.'/'.$nasabah_id ?>" method="post">
