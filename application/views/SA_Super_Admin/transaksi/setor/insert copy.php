...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h5 class="h5 mb-0 text-gray-800">(Nomor Transaksi : <?php $kode_transaksi = $this->m_transaksi->Kode_otomatis(); echo $kode_transaksi?>)</h5>
          </div>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Formulir Setor Sampah</a></li>
          </ol>
              ...
              <div class="card shadow mb-4">
                ...
                <table class="table table-bordered table-striped mb-none">
                    ...
                    <tbody>
                      ...
                      foreach($nasabah_transaksi_detail as $n ){
                        ...
                        <td><?= $no++;?></td>
                            ...
                            <td>
                            <a class="btn btn-danger btn-sm" href="<?= base_url().'c_setor/delete_item/'.$kode_transaksi;?>" onclick="return confirm('Yakin ingin menghapus item : <?php echo $n->deskripsi;?> ?');"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                            </td>
                        </tr>
                        <?php }?>
                        <tr>
                  ...
                  <form  action="<?php echo base_url().'c_setor/updateTransaksi/'.$kode_transaksi?>" method="post">
                    ...
                    <textarea name="deskripsi" id="deskripsi" style="width: 400px; height: 100px;"></textarea>
