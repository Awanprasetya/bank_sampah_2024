          ...
          <?php echo $this->session->flashdata('alert_2');?>
            <div class="row mb-3">
                <div class="col">
                    ...
                    <a class="btn btn-outline-success" data-toggle="modal" data-target="#insertTransaksiModal"><i class="fa fa-plus"></i>&nbsp;Setor</a>
                    ...
                    <!-- <a  class="btn btn-outline-success" href="<?= base_url().'c_setor/v_insert'?>">Setor</a> -->
