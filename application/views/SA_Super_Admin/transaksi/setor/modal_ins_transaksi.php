...
<div class="modal" id="insertTransaksiModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-bordered" name="autoSumForm" autocomplete="off" action="<?php echo base_url().'c_setor/ins_nasabah_transaksi' ?>" method="post">
      ...
      <div class="input-group-prepend">
        ...
        <input type="text"  name="harga" id="harga" class="form-control" aria-label="Sizing example input" value="<?php $kode_transaksi = $this->m_transaksi->Kode_otomatis(); 
        echo $kode_transaksi;?>" disabled>
      </div>
      </div>
      </div>
      <div class="row ml-3">
