            ...
            <div class="col-lg-8 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Saldo KRL </h6>
                </div>
                <div class="card-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      foreach($saldo_krl as $n ){
                        ?>
                        <tr>
                            <td><?= $no++;?></td>
                            <td><?= $n->krl_nama?></td>
                            <td><?= $n->kecamatan_nama?></td>
                            <td><?= "Rp.".number_format($n->saldo_krl)?></td>
