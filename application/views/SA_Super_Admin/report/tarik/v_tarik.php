...
<div class="container-fluid">
  ...
  <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="<?=  base_url().'c_report/v_setor' ?>">Setor Sampah</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= base_url().'c_report/v_tarik'?>">Penarikan Saldo</a>
            </li>
            </ul>
            <br>
            <!-- <div class="row mb-3">
          ...
          <div class="row">
            ...
            <div class="col-lg-10 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form method="post" action="<?php echo base_url('c_report/filter_tarik'); ?>">
                    <div class="row mb-3">
                        <div class="col">
                ...
                <table class="table table-bordered table-striped mb-none">
                    ...
                    <tbody>
                      <?php foreach($get_laporan_tarik as $n ){
