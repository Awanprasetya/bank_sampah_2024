...
<div class="container-fluid">
  ...
  <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="<?=  base_url().'c_jenis_sampah/index' ?>">Setor Sampah</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= base_url().'c_report/index'?>">Penarikan Saldo</a>
            </li>
            </ul>
            <br>
            <!-- <div class="row mb-3">
