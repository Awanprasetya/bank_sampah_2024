...
<?php echo $this->session->flashdata('alert_1');?>
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item "><a href="#">Detail Nasabah</a></li>
          </ol>
        
          <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?=  base_url().'c_data_nasabah/index' ?>" >Detail Nasabah</a>
            </li>
           ...
           <div class="row mb-3">
                <div class="col">
                <a class="btn btn-outline-primary"  href="<?php echo base_url().'c_data_nasabah/index'?>" >Kembali</a>
                </div>
            </div>
          <div class="row" align="middle">
            ...
            <div class="col-md-3 mb-4" >
              ...
              <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url().'c_data_nasabah/edit_photo_nasabah/'.$r->registrasi_id ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="col" style="width:50%;">
              ...
              <div class="card shadow mb-4">
                ...
                <thead>
                    ...
                    <th>Nama</th>
                    <td>
                    <form action="<?php echo base_url().'c_data_nasabah/edit_nasabah_nama/'.$r->registrasi_id ?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                      <div class="col-md-4">
                    ...
                    <th>Alamat</th>
                    <td>
                    <form action="<?php echo base_url().'c_data_nasabah/edit_alamat_nasabah/'.$r->registrasi_id ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                    <div class="col-md-9">
                    ...
                    <th>KRL</th>
                    <td>
                    <form action="<?php echo base_url().'c_data_nasabah/edit_krl_nasabah/'.$r->registrasi_id ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                    <div class="col-md-9">
                      <select name="krl_id" id="krl_id" class="form-control">
                      <option value="<?php echo $r->krl_id?>" required><?php echo $r->krl_nama?></option>
                        <?php foreach($krl_master as $k){?>
                        <option value="<?php echo $k->krl_id?>" required><?php echo $k->krl_nama?></option>
                        <?php }?>
                      </select>
                      </div>
                    <button type="submit" class="btn btn-outline-primary btn-sm">Simpan</button>
                    ...
                    <th>Email</th>
                    <td>
                    <form action="<?php echo base_url().'c_data_nasabah/edit_email_nasabah/'.$r->registrasi_id ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                    <div class="col-md-9">
                    ...
                    <td>
                    <form action="<?php echo base_url().'c_data_nasabah/edit_file_nasabah/'.$r->registrasi_id ?>" method="post" enctype="multipart/form-data">
