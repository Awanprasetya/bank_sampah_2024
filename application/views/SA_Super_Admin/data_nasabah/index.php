...
<?php echo $this->session->flashdata('alert_1');?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Akun Nasabah</h1>
          </div>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard/index' ?>"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="#">Data Akun Nasabah</a></li>
          </ol>
        
          <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?=  base_url().'c_user/index' ?>" >Data Akun Nasabah</a>
            </li>
            ...
            <div class="col-lg-10 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Akun Nasabah </h6>
                </div>
                <div class="card-body">
                ...
                <table id="example" class="table table-striped table-bordered" >
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      foreach($get_nasabah as $r ){
                    
                        ?>
                        <tr>
                            <td><?= $no++;?></td>
                            <td><?= $r->nasabah_nama?></td>
                            <td><?= $r->krl_nama;?></td>
                            <td><?= $r->email?></td>
                            <td><?= $r->user_level?></td>
                            ...
                            <?php if($this->session->userdata('user_level') == 'SA_SuperAdmin'){?>
                                <a class="btn btn-info btn-sm" href="<?php echo base_url().'c_data_nasabah/v_detail/'.$r->registrasi_id?>"><i class="fa fa-eye" ></i>&nbsp;Detail</a>
                                <a class="btn btn-danger btn-sm" onclick = "return confirm('Yakin ingin menghapus data : <?php echo $r->nasabah_nama;?>');" href="<?php echo base_url().'c_data_nasabah/delete/'. $r->nasabah_id;?>" ><i class="fa fa-trash" ></i>&nbsp;Hapus</a>
                           <?php }else{?>
                            <a class="btn btn-info btn-sm" href="<?php echo base_url().'c_data_nasabah/v_detail/'.$r->registrasi_id?>"><i class="fa fa-eye" ></i>&nbsp;Detail</a>
                              <?php }?>
                            </td>
