...
<div class="container-fluid">
      ...
      <?php echo $this->session->flashdata('alert_1');?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Kelurahan/Desa</h1>
          </div>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Kelurahan/Desa</a></li>
          </ol>
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?=  base_url().'c_desa/index' ?>" >Data Kelurahan/Desa</a>
            </li>
            <li class="nav-item">
                    ...
                    <tbody>
                      ...
                      foreach($desa as $d ){
                        ...
                        <tr>
                            ...
                            <td><?= $d->desa_id?></td>
                            <td><?= $d->desa_nama?></td>
                            <td><?= $d->kecamatan_nama?></td>
                            <td align="center">
                                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $d->desa_id?>"><i class="fa fa-edit" ></i>&nbsp;Edit</a>
                                <a class="btn btn-danger btn-sm" onclick = "return confirm('Yakin ingin menghapus data : <?php echo $d->desa_nama;?>');" href="<?php echo base_url().'c_desa/delete/'. $d->desa_id;?>" ><i class="fa fa-trash" ></i>&nbsp;Hapus</a>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
