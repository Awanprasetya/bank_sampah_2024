...
<?php echo $this->session->flashdata('alert_1');?>
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?=  base_url().'c_kecamatan/index' ?>" >Data Kecamatan</a>
            </li>
            <li class="nav-item">
                ...
                <table id="example" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      foreach($kecamatan as $km ){
                        ...
                        <tr>
                            <td><?= $no++;?></td>
                            <td><?= $km->kecamatan_id?></td>
                            <td><?= $km->kecamatan_nama?></td>
                            <td align="center">
                                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $km->kecamatan_id?>"><i class="fa fa-edit" ></i>&nbsp;Edit</a>
                                <a class="btn btn-danger btn-sm" onclick = "return confirm('Yakin ingin menghapus data : <?php echo $km->kecamatan_nama;?>');" href="<?php echo base_url().'c_kecamatan/delete/'. $km->kecamatan_id;?>" ><i class="fa fa-trash" ></i>&nbsp;Hapus</a>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
