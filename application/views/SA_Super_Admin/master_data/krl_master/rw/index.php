...
<?php echo $this->session->flashdata('alert_1');?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data RW</h1>
          </div>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">RW</a></li>
          </ol>
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?=  base_url().'c_rw/index' ?>" >Data RW</a>
            </li>
            <li class="nav-item">
                    ...
                    <tbody>
                      ...
                      foreach($get_desa_rw as $r ){
                        ...
                        <tr>
                            ...
                            <td><?= $r->desa_nama?></td>
                            <td align="center">
                                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal<?= $r->rw_id?>"><i class="fa fa-edit" ></i>&nbsp;Edit</a>
                                <a class="btn btn-danger btn-sm" onclick = "return confirm('Yakin ingin menghapus data : <?php echo $r->rw_id;?>');" href="<?php echo base_url().'c_rw/delete/'. $r->rw_id;?>" ><i class="fa fa-trash" ></i>&nbsp;Hapus</a>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
