...
<div class="modal" id="insertModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-bordered" name="autoSumForm" autocomplete="off" action="<?php echo base_url().'c_rt/insert' ?>" method="post">
      ...
      <div class="input-group-prepend">
        ...
        <input type="number" name="rt_nama" id="rt_nama" class="form-control " style="width: 100%;" tabindex="-1" aria-hidden="true" required>  
        </div>
        </div>
        <div class="col-md-9 ml-3">
      <div class="input-group input-group-default mb-3">
