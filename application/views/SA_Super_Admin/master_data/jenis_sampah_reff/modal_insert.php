...
<div class="modal" id="insertModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-bordered" name="autoSumForm" autocomplete="off" action="<?php echo base_url().'c_jenis_sampah_reff/insert' ?>" method="post">
      ...
      <div class="input-group-prepend">
        ...
        <input type="text" name="deskripsi" id="deskripsi" class="form-control " style="width: 100%;" tabindex="-1" aria-hidden="true" required>  
        </div>
        </div>
      </div>
